      ...
      <section id="portfolio" class="white">
        <div class="container">
          ...
          <ul class="portfolio-filter fade-down center">
            ...
            <li>
              <a class="btn btn-outlined btn-primary" href="#" data-filter=".bootstrap">Bootstrap</a>
            </li>
            <li>
              <a class="btn btn-outlined btn-primary" href="#" data-filter=".html">HTML</a>
            </li>
            <li>
              <a class="btn btn-outlined btn-primary" href="#" data-filter=".wordpress">Wordpress</a>
            </li>
          </ul>
          <!--/#portfolio-filter-->
              ...
              <div class="item-inner">
                ...
                <div class="overlay">
                  <a
                    ...
                    href="http://placehold.it/800x600"
                    rel="prettyPhoto"
                  >
                    <i class="fa fa-eye"></i>
                  </a>
